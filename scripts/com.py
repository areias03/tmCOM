...
class CommunityModel:
    ...
    def _merge_models(self):
        ...
        for org_id, model in self.organisms.items():
            ...
            print(f'Adding internal compartments')
            for c_id in tqdm(model.compartments):
            ...
            # add metabolites
            print(f'Adding metabolites')
            for m_id in tqdm(model.metabolites):
            ...
            # add genes
            print(f'Adding genes')
            for g_id in tqdm(model.genes):
                new_id = r_gene(g_id)
            ...
            # add reactions
            print(f'Adding reactions')
            ex_rxns = model.get_exchange_reactions()
            
            for r_id in tqdm(model.reactions):
        ...
        print(f'Adding exchange reactions')
