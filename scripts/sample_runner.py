...
def main():
    ...
    with ProcessPoolExecutor() as p:
        for result_all, result_single in p.map(generate_com, [[bt,ss]]):
    ...
    print('Single:\n')
    print(df_single)
    df_all.to_csv('../data/results/ne_fba_btss.csv')
    df_single.to_csv('../data/results/ne_fba_single_btss.csv')
