...
def main():
    ...
    with ProcessPoolExecutor() as p:
        for result_all, result_single, result_sc, result_abun_sc in p.map(generate_com, [[bt, bu], [bt, fn], [bt, ri], [bt, sp]]):
    ...
    print('Single:\n')
    print(df_abun_sc)
    df_all.to_csv('results/ne_fba_all.csv')
    df_single.to_csv('results/ne_fba_single_all.csv')
    df_sc.to_csv('results/ne_sc_all.csv')
    df_abun_sc.to_csv('results/ne_sc_single_all.csv')
