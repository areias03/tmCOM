...
def main():
    ...
    with ProcessPoolExecutor() as p:
        for result_all, result_single, result_sc, result_abun_sc in p.map(generate_com, [[ec_bt, ec_ec], [ec_bt, ec_ss]]):
    ...
    print('Single:\n')
    print(df_abun_sc)
    df_all.to_csv('results/ec_fba_ecss.csv')
    df_single.to_csv('results/ec_fba_single_ecss.csv')
    df_sc.to_csv('results/ec_sc_ecss.csv')
    df_abun_sc.to_csv('results/ec_sc_single_ecss.csv')
