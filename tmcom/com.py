...
class CommunityModel:
    ...
    def _merge_models(self):
        ...
        for org_id, model in self.organisms.items():
            ...
            for c_id in tqdm(model.compartments,'Adding internal compartments'):
            ...
            # add metabolites
            for m_id in tqdm(model.metabolites,'Adding metabolites'):
            ...
            # add genes
            for g_id in tqdm(model.genes,'Adding genes'):
                new_id = r_gene(g_id)
            ...
            for r_id in tqdm(model.reactions,'Adding reactions'):
        ...
        for m_id in tqdm(ext_mets,'Adding exchange reactions'):
